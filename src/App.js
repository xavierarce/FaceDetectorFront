...
import { serverPictureSubmit, serverPutPicture } from "./API/serverFunctions";
...
class App extends Component {
  ...
  onPictureSubmit = () => {
    ...
    const imageUrlToSend = this.state.input;
    serverPictureSubmit(imageUrlToSend)
      ...
      .then((result) => {
        ...
        if (result) {
          const IdToSend = this.state.user.id;
          serverPutPicture(IdToSend)
